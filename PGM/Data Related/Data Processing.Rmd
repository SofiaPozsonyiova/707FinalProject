...
```{r}
dat_sub <- dat_sub %>% dplyr::select(P1,P2,Biosex,P5,P8,P11:P14a,P14ab1:P14ab14,P15:P17c,P18b:P18d,P20a:P20c,P20f:P22a,P22e,P23c,P23e,P25:P26h,P27b,P27c,P27e:P29f,P30:P39a,P40a:P40d,P41b:P41e,P41g:P42d,P45,P47a:P47e,P49d,P49a,P49c:P50d,P52a:P52c,P54a:P54b,P56a:P56c,P58a:P58c,P59:P66,P70a,P70c:P70d,P71a:P71d,P74,P76,P80c:P80g,P80i:P81,P86,FiveFV,Binge,Region)
```
...
```{r}
t <- na.omit(dat_sub_named)
plot_bar(dat_sub_named$SelfPerceivedHealth)
plot_bar(t $SelfPerceivedHealth)

dat_sub_named %>% group_by(SelfPerceivedHealth) %>% count()
t %>% group_by(SelfPerceivedHealth) %>% count()
```
