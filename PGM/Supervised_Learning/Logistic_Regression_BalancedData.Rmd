...
Train1$P2 <- as.numeric(Train1$P2)
Test1 <- Test %>% subset(select = -c(P28))
Test1$P2 <- as.numeric(Test1$P2)
Validation1 <- final_test %>% subset(select = -c(P28))
Validation1$P2 <- as.numeric(Validation1$P2)
...
predicted_binary <- rep(NA, length(predicted))
predicted_binary[predicted > 0.5] <- 1
predicted_binary[predicted <= 0.5] <- 0
predicted_binary <- as.factor(predicted_binary)

predicted_optimal <- rep(NA, length(predicted))
predicted_optimal[predicted > optimal] <- 1
predicted_optimal[predicted <= optimal] <- 0
predicted_optimal <- as.factor(predicted_optimal)


# Run confusion matrix
confusionMatrix(Test1$SelfPerceivedHealth, predicted_binary)

# Add optimal threshold (update 1/23/23)
confusionMatrix(Test1$SelfPerceivedHealth, predicted_optimal)
```
   
```{r}
# Calculate sensitivity
sensitivity(Test1$SelfPerceivedHealth, predicted_optimal)

# Calculate specificity
specificity(Test1$SelfPerceivedHealth, predicted_optimal)

# Calculate total missclassification error rate
misClassError(Test1$SelfPerceivedHealth, predicted)
```
...
# Add optimal threshold (update 1/23/23)
confusionMatrix(Validation1$SelfPerceivedHealth, predicted_validation, threshold=optimal_val)
...
Val_sub20 <- final_test %>% dplyr::select(c(P49f,P49l,P26a,P50b,P49a,P37,P49h,P45,P49i,P49e,P34,P47e,P50c,P41g,P47a,P50d,P47b,P49p,P49d,P50a,SelfPerceivedHealth))

Val_sub5 <- final_test %>% dplyr::select(c(P37,P49f,P45,P26a,P49l,SelfPerceivedHealth))

Val_sub2 <- final_test %>% dplyr::select(c(P49f,P49l,SelfPerceivedHealth))

Val_sub1 <- final_test %>% dplyr::select(c(P49f,SelfPerceivedHealth))
```
...
# Add optimal threshold to confusion matrix (update 1/23/23)
confusionMatrix(Test_sub20$SelfPerceivedHealth, predicted20, threshold=optimal20)
...
# Add optimal threshold to confusion matrix (Update 1/23/23)
confusionMatrix(Val_sub20$SelfPerceivedHealth, predicted20_val, threshold=optimal20_val)
...
# Add optimal threshold to confusion matrix (Update 1/23/23)
confusionMatrix(Test_sub5$SelfPerceivedHealth, predicted5, threshold=optimal5)
...
# Add optimal threshold to confusion matrix (Update 1/23/23)
confusionMatrix(Val_sub5$SelfPerceivedHealth, predicted5_val, threshold=optimal5_val)
...
# Add optimal threshold to confusion matrix (Update 1/23/23)
confusionMatrix(Test_sub2$SelfPerceivedHealth, predicted2, threshold=optimal2)
...
# Add optimal threshold to confusion matrix (Update 1/23/23)
confusionMatrix(Val_sub2$SelfPerceivedHealth, predicted2_val, threshold=optimal2_val)
...
# Add optimal threshold to confusion matrix (Update 1/23/23)
confusionMatrix(Test_sub1$SelfPerceivedHealth, predicted1, threshold=optimal1)
...
# Add optimal threshold to confusion matrix (Update 1/23/23)
confusionMatrix(Val_sub1$SelfPerceivedHealth, predicted1_val, threshold=optimal1_val)
