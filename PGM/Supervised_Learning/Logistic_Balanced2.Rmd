...
# Get odds ratios
exp(summary(log_reg_5)$coefficients[2]) # P49f
exp(summary(log_reg_5)$coefficients[3]) # P49a
exp(summary(log_reg_5)$coefficients[4]) # P50b
exp(summary(log_reg_5)$coefficients[6]) # P49l
exp(summary(log_reg_5)$coefficients[5]) # P37
...
## Likelihood ratio tests for unbalanced model
```{r}
# 126 predictors vs. 12 predictors
lrtest(log_reg_all$finalModel, log_reg_12$finalModel)

# 12 predictors vs. 5 predictors
lrtest(log_reg_12$finalModel, log_reg_5$finalModel)

# 126 predictors vs. 5 predictors
lrtest(log_reg_all$finalModel, log_reg_5$finalModel)
```
